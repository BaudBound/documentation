---
title: Deployment
description: Self-host the editor and run the BaudBound service under systemd, OpenRC, or runit.
tags: [deployment, operations, linux]
---
# Deployment
...
Use the service manager provided by the distribution. systemd is the normal choice on Debian, Ubuntu, Fedora, Arch, and their common derivatives. Alpine and Gentoo use OpenRC by default, while Void Linux uses runit.
...
On Alpine, replace the `useradd` command with its native account tools:
