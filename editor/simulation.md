...
Before release, simulate every trigger, branch, error path, loop termination, and expected output. Then validate and inspect the exported package as described in [Script Management](../runner/script-management.md).
