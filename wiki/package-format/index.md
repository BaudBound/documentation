...
Run `pnpm schemas:check` from the editor repository and run the runner workspace tests before merging a coordinated contract change. [Editor and Package Development](../developers/editor.md) owns the editor workflow.
